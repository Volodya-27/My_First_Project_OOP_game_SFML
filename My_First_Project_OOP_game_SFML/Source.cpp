...
public:
	void man_Up(RenderWindow& window)
	{
		...
		while (window.isOpen())
		{
			...
			//якщо вбиваємо бота зписуємо у фалик 1			
			ofstream out;
			...
			if (out.is_open() && die_the_bot == true)
				out << "1" << std::endl;
			out.close();
			//ifstream in("C:\\Users\\linec\\source\\repos\\My_First_Project_OOP_game_SFML\\My_First_Project_OOP_game_SFML\\die.txt"); // окрываем файл для чтения
			//if (!in.eof())
			//{
			//	getline(in, line);
			//}
			...
			//if (i == 1)
			//{
			//	up = "C:\\Users\\linec\\Desktop\\fila\\newtank.png";
			//	right = "C:\\Users\\linec\\Desktop\\fila\\newtank_right.png";
			//}
